...
#define MAX_OUTS                    1   // was 2

#define HAS_RGBX8_YUVX8         0   // was 1
#define HAS_YUYV8               0   // was 1
#define HAS_RGBA8_YUVA8         0
#define HAS_RGBX10_YUVX10       0   // was 1
#define HAS_Y_UV8_Y_UV8_420     1   // ← KEEP - NV12 camera input
#define HAS_RGB8_YUV8           1   // ← KEEP - RGB output to DPU
#define HAS_Y_UV10_Y_UV10_420   0   // was 1
#define HAS_Y8                  0   // was 1
#define HAS_Y10                 0   // was 1
#define HAS_BGRA8               0
#define HAS_BGRX8               0   // was 1
#define HAS_UYVY8               0   // was 1
#define HAS_BGR8                0   // was 1
#define HAS_R_G_B8              0   // was 1
#define HAS_Y_U_V8_420          0   // was 1
/* Memory Ports */
